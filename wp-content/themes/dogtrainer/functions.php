...
function twentyseventeen_widgets_init() {
    ...
    register_sidebar(
            array(
                ...
                'id' => 'header-1',
                'description' => __('Add widgets here to appear in your header left.', 'twentyseventeen'),
                'before_widget' => '<section id="%1$s" class="widget %2$s">',
                'after_widget' => '</section>',
                'before_title' => '<h2 class="widget-title">',
                'after_title' => '</h2>',
    ...
    register_sidebar(
            array(
                'name' => __('Header 2', 'twentyseventeen'),
                'id' => 'header-2',
                'description' => __('Add widgets here to appear in your header right.', 'twentyseventeen'),
                'before_widget' => '<section id="%1$s" class="widget %2$s">',
                'after_widget' => '</section>',
                'before_title' => '<h2 class="widget-title">',
                'after_title' => '</h2>',
    ...
    register_sidebar(
            array(
                'name' => __('Home Header Boxes', 'twentyseventeen'),
                'id' => 'header-box',
                'description' => __('Add widgets here to appear in your header boxes.', 'twentyseventeen'),
                'before_widget' => '<section id="%1$s" class="widget %2$s">',
                'after_widget' => '</section>',
                'before_title' => '<h2 class="widget-title">',
                'after_title' => '</h2>',
    ...
    register_sidebar(
            array(
                ...
                'id' => 'contact-us',
                'description' => __('Add widgets here to appear in Footer.', 'twentyseventeen'),
                'before_widget' => '<section id="%1$s" class="widget %2$s">',
                'after_widget' => '</section>',
                'before_title' => '<h2 class="widget-title">',
                'after_title' => '</h2>',
    ...
    register_sidebar(
            array(
                'name' => __('Working Time', 'twentyseventeen'),
                'id' => 'working-time',
                'description' => __('Add widgets here to appear in Footer.', 'twentyseventeen'),
                'before_widget' => '<section id="%1$s" class="widget %2$s">',
                'after_widget' => '</section>',
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="testimonial-image-box">
                                            <?= the_post_thumbnail('thumbnail', array('class' => 'img-responsive testimonial-image')) ?>
                                        </div>                                
                                        <div class="testimonial-name"><?php echo get_the_title(); ?></div>
                                    </div>
                                </div>
                            </div>
                        <?php endwhile; ?>
